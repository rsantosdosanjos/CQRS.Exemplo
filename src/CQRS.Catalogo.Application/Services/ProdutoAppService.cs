using AutoMapper;
using CQRS.Catalogo.Application.Interfaces;
using CQRS.Catalogo.Application.ViewModels;
using CQRS.Catalogo.Domain.Entities;
using CQRS.Catalogo.Domain.Interfaces.Repository;
using CQRS.Catalogo.Domain.Interfaces.Services;
using CQRS.Core.DomainObjects;
using System;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace CQRS.Catalogo.Application.Services
{
