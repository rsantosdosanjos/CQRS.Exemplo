...
using CQRS.Core.Messages.CommonMessages.IntegrationEvents.Pedido;
using CQRS.Core.Messages.Notifications;
using CQRS.Vendas.Application.Events;
using CQRS.Vendas.Domain.Etities;
using CQRS.Vendas.Domain.Interfaces;
using MediatR;
...
namespace CQRS.Vendas.Application.Commands
{
